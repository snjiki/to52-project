...
class OtherInfo extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      localAddress: "Utbm Belfort",
      city: "Belfort",
      department: "Franche Comté",
      country: "France",
      pinCode: "90000",
      email: "to52@gmail.com",
      phone: "0601010101"
    };
  }
      ...
      return (
        <div className="lIWrapper" key="lIWrapperText">
          <div className="inputWrapper">
            ...
            <p className="inputData">{this.state.localAddress}</p>
          </div>
          <div className="inputWrapper">
            <label>City:</label>
            <p className="inputData">{this.state.city}</p>
          </div>
          <div className="inputWrapper">
            <label>Department:</label>
            <p className="inputData">{this.state.department}</p>
          </div>
          <div className="inputWrapper">
          ...
          <div className="inputWrapper">
            <label>Country:</label>
            <p className="inputData">{this.state.country}</p>
          </div>
          <div className="inputWrapper">
            <label>Pin Code:</label>
            <p className="inputData">{this.state.pinCode}</p>
          </div>
        </div>
      );
    }
      ...
      return (
        <div className="cIWrapper" key="cIWrapperText">
          ...
          <div className="inputWrapper">
            ...
            <p className="inputData">{this.state.phone}</p>
          </div>
        </div>
      );
    }
